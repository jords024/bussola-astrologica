...
import CheckoutModal, { formatPhoneByCountry, COUNTRIES } from '@/components/bussola/checkout-modal';
...
describe('CheckoutModal Component with Country Selector', () => {
  ...
  it('should display validation errors when submitting invalid inputs', async () => {
    ...
    render(
      <CheckoutModal isOpen={true} onClose={vi.fn()} onSubmit={handleSubmit} />
    );
  ...
  it('should call onClose when close button is clicked', () => {
    ...
    render(
      <CheckoutModal isOpen={true} onClose={handleClose} onSubmit={vi.fn()} />
    );
