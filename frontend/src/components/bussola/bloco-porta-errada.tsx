...
import erradaAsset from "../../assets/bussola-porta-errada.webp";

export default function BlocoPortaErrada() {
  ...
  return (
    <section
      ref={sectionRef}
      aria-label="Talvez você só esteja tentando abrir a porta errada"
    ...
    >
      <div
        ...
        style={{
          background:
            "radial-gradient(48% 38% at 50% 55%, color-mix(in oklab, var(--gold) 18%, transparent) 0%, transparent 72%)",
        }}
      />
      ...
      <div className="relative w-screen max-w-none px-0 md:mx-auto md:w-full md:max-w-lg md:px-6 lg:max-w-xl">
        <div ref={imageRef} className="relative w-full will-change-transform">
          <img
            src={erradaAsset}
            alt="Até olhar para o próprio ombro roxo e concluir: 'tem alguma coisa errada comigo.' Não necessariamente. Talvez você só esteja tentando abrir a porta errada — uma mulher encostada numa porta escura olha para um corredor iluminado que leva a outra porta aberta."
