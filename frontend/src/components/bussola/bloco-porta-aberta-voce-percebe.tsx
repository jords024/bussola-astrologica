...
import percebeAsset from "../../assets/bussola-porta-aberta-voce-percebe.webp";

export default function BlocoPortaAbertaVocePercebe() {
  ...
  return (
    <section
      ref={sectionRef}
      aria-label="Quando uma porta está aberta, você percebe"
    ...
    >
      ...
      <div className="relative w-screen max-w-none px-0 md:mx-auto md:w-full md:max-w-lg md:px-6 lg:max-w-xl">
        <div ref={imageRef} className="relative w-full will-change-transform">
          <img
            src={percebeAsset}
            alt="Quando uma porta está aberta, você percebe: o cliente aparece quase na hora certa, a conversa que você vinha adiando finalmente acontece, a oportunidade surge, uma ideia encaixa, uma mudança que parecia impossível começa a acontecer com uma facilidade que você não consegue explicar."
