...
import naoCedeAsset from "../../assets/bussola-porta-nao-cede.webp";

export default function BlocoPortaNaoCede() {
  ...
  return (
    <section
      ref={sectionRef}
      aria-label="E quando a porta não cede"
    ...
    >
      ...
      <div className="relative w-screen max-w-none px-0 md:mx-auto md:w-full md:max-w-lg md:px-6 lg:max-w-xl">
        <div ref={imageRef} className="relative w-full will-change-transform">
          <img
            src={naoCedeAsset}
            alt="E quando a porta não cede... você insiste, tenta novamente, coloca mais força, persevera, empurra com o ombro usando toda a sua força."
