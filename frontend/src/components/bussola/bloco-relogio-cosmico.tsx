  ...
  return (
    ...
    >
      ...
      <div className="relative mx-auto w-full max-w-2xl px-5 text-center sm:px-6">
        ...
        <p
          data-reveal
          className="mt-8 text-lg leading-relaxed text-foreground/85 sm:text-xl"
        >
        ...
        <p
          data-reveal
          className="mt-5 text-lg leading-relaxed text-foreground/85 sm:text-xl"
        >
          E a segunda de{" "}
        ...
        <div data-reveal aria-hidden className="mx-auto my-10 flex items-center justify-center gap-3">
        ...
        >
          Só que existe uma{" "}
          <span className="font-semibold text-gold">terceira possibilidade</span>{" "}
        ...
        >
          ...
          <span className="text-gold-gradient">“Relógio cósmico”</span> só seu, por
          isso, você nunca vive exatamente o mesmo momento duas vezes…
        </p>

        <p
          data-reveal
          className="mt-10 text-base leading-relaxed text-foreground/75 sm:text-lg"
        >
