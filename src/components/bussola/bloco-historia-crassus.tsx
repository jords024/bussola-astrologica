    ...
    >
      ...
      <div className="relative mx-auto max-w-5xl px-6">
        ...
        <div className="mt-12 md:mt-16">
          <p
            data-reveal
            className="mx-auto max-w-3xl text-center text-[15.5px] leading-[1.85] text-muted-foreground md:text-base"
          >
            E aí eu fiz o que todo mundo faz nessa hora — o que talvez você esteja fazendo neste exato
            momento:{" "}
            <span className="font-body text-foreground">usei a culpa como escudo.</span>
          </p>
          ...
          >
            {[
              "“Sou eu que não sei aproveitar o que tenho.”",
              "“Sou ingrato.”",
              "“Sou eu que nunca me contento.”",
            ].map((frase) => (
              <li
                key={frase}
                className="rounded-2xl border border-gold/18 px-5 py-6 text-center font-display text-[1.05rem] leading-[1.5] text-muted-foreground"
                style={{
                  background:
          ...
          <p
            data-reveal
            className="mx-auto mt-10 max-w-2xl text-center font-display text-[1.35rem] leading-[1.5] text-foreground md:text-[1.7rem]"
          >
            Até perceber que talvez o problema não fosse eu. Eu estava apenas tentando forçar{" "}
            <em className="italic text-gold">uma porta que não estava aberta pra mim</em> — e, em vez de
            perceber isso, passei anos me culpando por não conseguir atravessá-la.
          </p>
        </div>
        ...
        <div className="mt-14 md:mt-20">
          <div
            data-reveal
            className="mx-auto max-w-3xl rounded-[24px] border border-gold/25 p-7 text-center md:p-10"
            style={{
              background:
                "linear-gradient(168deg, color-mix(in oklab, var(--gold) 7%, var(--background)) 0%, var(--background) 78%)",
            }}
          >
            <p className="text-[15.5px] leading-[1.85] text-muted-foreground md:text-base">
              Decidi respeitar meu mapa e meus ciclos. Há{" "}
              <span className="text-gold">6 anos</span> venho vivendo somente de astrologia, consegui
              viajar o mundo e hoje somo quase{" "}
              <span className="text-gold">6 mil clientes</span> — graças ao conhecimento resgatado da
              astrologia real, aplicada no dia a dia.
            </p>
            <div className="mt-8 grid gap-4 sm:grid-cols-3">
              {[
                { k: "6 anos", v: "vivendo de astrologia" },
                { k: "~6 mil", v: "clientes atendidos" },
                { k: "50 anos", v: "de tradição em casa" },
              ].map((s) => (
                <div key={s.k} className="rounded-2xl border border-gold/15 px-4 py-5">
                  <div className="font-display text-[1.9rem] leading-none text-gold">{s.k}</div>
