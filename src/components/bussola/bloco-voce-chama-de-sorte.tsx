...
import sorteAsset from "../../assets/bussola-voce-chama-de-sorte.webp";

export default function BlocoVoceChamaDeSorte() {
  ...
  return (
    <section
      ref={sectionRef}
      aria-label="Você chama isso de sorte"
    ...
    >
      ...
      <div className="relative w-screen max-w-none px-0 md:mx-auto md:w-full md:max-w-lg md:px-6 lg:max-w-xl">
        <div ref={imageRef} className="relative w-full will-change-transform">
          <img
            src={sorteAsset}
            alt="Você chama isso de sorte. Diz que 'as coisas simplesmente fluíram', que 'as portas se abriram'. Você já usa essa linguagem — só nunca imaginou que a astrologia levasse essa ideia tão a sério."
