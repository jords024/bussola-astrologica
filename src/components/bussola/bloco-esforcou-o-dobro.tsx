...
import esforcouAsset from "../../assets/bussola-esforcou-o-dobro.webp";

export default function BlocoEsforcouODobro() {
  ...
  return (
    <section
      ref={sectionRef}
      aria-label="Teve ano em que você se esforçou o dobro"
    ...
    >
      ...
      <div className="relative w-screen max-w-none px-0 md:mx-auto md:w-full md:max-w-lg md:px-6 lg:max-w-xl">
        <div ref={imageRef} className="relative w-full will-change-transform">
          <img
            src={esforcouAsset}
            alt="E teve ano em que você se esforçou o dobro: acordou cedo, tentou mais, insistiu mais... e mesmo assim parecia que nada saía do lugar. Uma mulher sentada de costas numa mesa, presa por correntes acorrentadas a bilhetes de papel na parede: acordar mais cedo, tentar mais, insistir mais, fazer mais, plano perfeito, disciplina todo dia. Nada se move."
